...
public class Skill_Base : MonoBehaviour
{
    ...
    public void SetSkillUpgrade(Skill_DataSO skillData)
    {
        ...
        player.ui.GetSkillSlot(skillType).SetupSkillSlot(skillData);
        ResetCooldown();
    }
